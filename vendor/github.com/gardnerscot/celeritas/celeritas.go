...
import (
	...
	"github.com/gardnerscot/celeritas/cache"
	"github.com/gardnerscot/celeritas/mailer"
	"github.com/gardnerscot/celeritas/render"
	"github.com/gardnerscot/celeritas/session"
...
func (c *Celeritas) New(rootPath string) error {
	...
	c.config = config{
		...
		database: databaseConfig{
			database: os.Getenv("DATABASWE_TYPE"),
			dsn:      c.BuildDSN(),
		},
		redis: redisConfig{
